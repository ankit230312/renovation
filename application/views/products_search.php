<?php
   ...
   isset($productIDs) ? "" : $productIDs = array();
...
<div class="container">
   <div class="row">
      <div class="col-md-3">
         <div style="box-shadow: 0 1px 1px 0 rgb(0 0 0 / 5%), 0 1px 2px 0 rgb(0 0 0 / 10%), 0 2px 20px 0 rgb(0 0 0 / 20%);position: sticky;top: 12px;">
            <div class="card-header bg-color text-white text-uppercase"><i class="fa fa-list"></i>  Shop By Categories</div>
            <div class="accordion">
               <?php
                  if(!empty($category)){
                ...
                if($products){
                  foreach($products as $p){
                    ...
                    if ($disc_min != '' && $disc_max != '') {
                      $discount = ceil((($p->retail_price-$p->price)/$p->retail_price)*100);
                      if ($discount >= $disc_min && $discount <= $disc_max){
                       $condition = true;
                     }
                   }else{
                     $condition = true;
               ...
               <div class="product-grid4">
                  ...
                  <div class="product-content">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-5" >
                           <a class="add-to-cart change_argument_new" onclick="add_to_cart(<?=$p->productID?>,<?=$varient_id?>,event);"><span id="add_cart_html<?=$p->productID?>"><?=$html?>&nbsp;&nbsp;<i class="fa fa-shopping-cart"></i> </span>
                           </a>
                        </div>
                     </div>
                  </div>
