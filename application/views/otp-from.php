        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 col-lg-6">
            <div class="header-top-right pull-right">
              <!-- Signin & Signup -->
              <button class="btn popup_btn" data-toggle="modal" data-target="#my-modal">Mobile OTP</button>
                                                  ...
                                                  <div class="col-sm-8 col px-sm-0 px-4">
                                                      ...
                                                      <div class="row">
                                                          <div class="col">
                                                            ...
                                                            <input type="text" id ="my_input" name="Enter Your OTP Code" placeholder="Enter Your OTP Code"></div>
                                                      </div>
                                                      <div class="row">
                                                          <div class="col">
