...
if (isset($_SESSION['loginUserID']) &&  $_SESSION['loginUserID'] == TRUE && $_SESSION['loginUserID'] != ''){
  ...
  $cart1 = $this->db->query("SELECT `users`.`ID` as userID, COALESCE(SUM(`qty`),0) as items FROM `product_cart` LEFT JOIN `users` ON `product_cart`.`userID` = `users`.`ID` WHERE `product_cart`.`userID`='$userID'")->row();
}else{
  $carts = [];
}
...
<head>
  ...
  <script src="<?=base_url('/');?>assets/js/1.5.jquery.min.js"></script>
   <script src="<?=base_url('/');?>assets/js/bootstrap.min.js"></script>
   <script src="<?=base_url('/');?>assets/js/jquery-1.11.1.min.js"></script>

   <title>Vadavital Nutritians</title>
         ...
         <div class="header-top py-1">
            <div class="row align-items-center">
               <div class="col-md-6 col-xs-12 col-sm-12 col-lg-4">
                  <ul class="header-top-left pull-left">
                     <li>
                        ...
                        <span>
                           <a href="https://wa.me/9643301302" target="_blank">+919871722048</a>
                        </span>
                     </li>
                     <li>
               ...
               <div class="col-md-6 col-xs-12 col-sm-12 col-lg-6">
                  <ul class="header-top-left pull-left">
                     <li style="color: #e4ff00;font-size: 18px;">
...
<!--                         Shop For 200/- &amp; get 200/- Cashback <b style="color: #ffc107;">Use Code: GOCASH200</b> -->
   ...
   <!--  <div id="navbar"> -->
      <div class="Main-menu">
         <div class="logo">
            <a href="<?=base_url('/')?>"><img src="<?=base_url('assets/')?>images/Helth.png" alt="logo.png"></a>
         </div>
         <div class="dropdown">
            <form class="d-flex pincode-div" id="pincode_submit" method="post" action="<?=base_url('home/pin')?>">
               ...
               <div class=" user location-div">
                  ...
                  <div class="row">
                    <div class="col-md-2 col-xs-4">
                     ...
                     <i class="fas fa-map-marker-alt" style="font-size: 18px;padding-top: 10px!important;"></i>
                  </div>  
                  <div class="col-md-6 col-xs-6">
                     <div>
                        ...
                        <div class="picode-del">
                           <p style="font-size: 14px; white-space: nowrap;"> Deliver to </p>
                           <p style="font-size: 14px;"><?=$pincode?></p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <ul class="dropdown-menu pincode-dropdown-menu user-menu">
              <h5 class="text-danger" id="pincode_error"> </h5>
              ...
              <span class="location">
               ...
               class="fas fa-map-marker-alt" style="font-size: 20px!important;padding-top: 10px!important;"></i>

               <button class="btn p-0" id="pincode_button"  style="color: red;font-weight: bold;">Apply</button> 
               <!--    <button class="btn p-0" id="pincode_button" onclick="set_pin(event)" style="color: red;font-weight: bold;">Apply</button> -->
            </span>
         </ul>
      </div>
...
<form action="<?=base_url('home/product_search')?>" method="post" autocomplete="off">
      ...
      <div class="search ui-widget open-search"> 
         <label class=""  for="tags" style="display:none;"></label>
        
         <button class="button-search" type="submit"><i class="fa fa-search"></i></button>
         <input type="hidden" name="select_category" value="">
         <input type="hidden" name="min_price" value="">
         <input type="hidden" name="max_price" value="">
         <input type="text" placeholder="Search For Products" id="tags" class="input-search" value="<?=$search_key?>" name="search_key" />
      ...
      <ul class="right-icon">
         <li class="dropdown user mt">
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
               ...
               <br>
               <span class="text"><?=$_SESSION['name']?></span>
            </a>
            <ul class="dropdown-menu user-menu" style="margin-left: -50px!important;">
               <li style="padding: 5px 10px!important;color: #444;font-weight: 400;line-height: 1.42857!important;white-space: nowrap; text-align: left;    border-width: 1px!important;border-bottom: dashed;"><a href="<?=base_url('home/profile')?>">
               ...
               <li style="padding: 5px 10px!important;color: #444;font-weight: 400;line-height: 1.42857!important;white-space: nowrap;    text-align: left;    border-width: 1px!important;border-bottom: dashed;"><a href="<?=base_url('home/order')?>">
                 
               My Order
               </a></li>
               <li style="padding: 5px 10px!important;color: #444;font-weight: 400;line-height: 1.42857!important;white-space: nowrap;    text-align: left;    border-width: 1px!important;border-bottom: dashed;"><a href="#" onclick="open_cart()">
               
                   <span> My Cart</span>  <span class="cart-count1"><?=$cart1->items?></span>
                 

           </a></li>
           <li style="padding: 5px 10px!important;color: #444;font-weight: 400;line-height: 1.42857!important;white-space: nowrap;    text-align: left;    border-width: 1px!important;border-bottom: dashed;"><a href="<?=base_url("home/wallet")?>">
             <div class="row">
               <div class="col-md-12">
                 My Wallet  ₹ <span><?php if (!empty($myprofile['wallet'])) {
                  echo $myprofile['wallet'];
                 }else{
                   echo 0;
                 }?></span>
              </div>
        ...
        <li style="padding: 5px 10px!important;color: #444;font-weight: 400;line-height: 1.42857!important;white-space: nowrap;    text-align: left; "><a href="#" onclick="logout_user(event)">Logout</a></li>
     </ul>
  </li>
  <li class="mt">
   <a href="#" onclick="open_cart()">
      <span class="cart-count" id="total_cart_value" style="color: #fff;"><?=$cart1->items?></span>
      <img src="<?=base_url('admin/uploads/shopping-cart.png');?>" alt="" width="25"><br>
                     ...
                     <div class="card-body pt-0">
                        <div class="row justify-content-center pb-sm-5 pb-3">
                           <div class="col-sm-8 col px-sm-0 px-4">
                              <a href="<?=base_url();?>"><img src="<?=base_url('assets/')?>images/logo.png" alt="logo.png" class="img-fluid"></a>
                              <p class="bg-warning" id="login_error" style="background: none; color: red;"></p>
                              <div class="row">
                                 <div class="col">
                                    <label class="mb-3" for="exampleInputEmail1">Enter Your Mobile Number</label>
                                    <input type="text"  id="user_mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" class="form-control" name="Enter Your mobile Number" placeholder="Enter Your mobile Number">
                                 </div>
                              </div>
                              <br>
                              <div class="row">
                                 <div class="col">
                                    <button type="button"  onclick="user_login(event)" class="btn btn-primary btn-block">Submit</button>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="card-body pt-0">
                        <div class="row justify-content-center pb-sm-5 pb-3">
                           <div class="col-sm-8 col px-sm-0 px-4">
                              ...
                              <div class="row">
                                 <div class="col">
                                    <button type="button" onclick="otp_submit(event)" class="btn btn-primary btn-block">Submit</button>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row justify-content-center pb-sm-5 pb-3">
                           <div class="col-sm-8 col px-sm-0 px-4">
                              ...
                              <div class="row">
                                 <div class="col">
                                    <label for="exampleInputEmail1">Enter Your OTP Code</label>
                                    <input type="text" class="form-control" maxlength="6" onkeypress="return onlyNumberKey(event)"  id="register_otp" placeholder="Please Enter OTP">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col">
                                    <button type="button" onclick="register_otp_submit(event)" class="btn btn-primary btn-block">Submit</button>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="col-sm-8 col px-sm-0 px-4">
                              ...
                              <div class="row">
                                 <div class="col mb-3">
                                    ...
                                    <input type="text"  class="form-control" id="register_name" name="Enter Your name" placeholder="Enter Your name">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col mb-3">
                                    <label for="exampleInputEmail1">Enter Your Mobile Number</label>
                                    <input type="text" class="form-control" id="register_mobile" onkeypress="return onlyNumberKey(event)" maxlength="10"   name="Enter Your number" placeholder="Enter Your number">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col mb-3">
                               ...
                               <div class="row">
                                 <div class="col mb-3">
                                    ...
                                    <input class="form-control" type="text" id="referral_code" name="Enter Your Referal Code" placeholder="Enter Your Referal Code">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col mb-3">
                                    <button type="button"  onclick="user_register_info(event)" class="btn btn-primary btn-block">Submit</button>
                                 </div>
                              </div>
                           </div>
                        </div>
