        ...
        <div class="subtitle-part subtitle-part2 mb-3 col-12 col-sm-3 text-center text-lg-left">
          ...
          <div class="subtitle-part-inner text-left">
            ...
            <div class="subtitile">
              ...
              <div class="subtitile1">60 minute delivery</div>
  ...
  <div class="container">
    <div class="row footer py-5">
      ...
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
       ...
       <a href="<?=base_url();?>">
        <img src="<?=base_url('assets/')?>images/logo.png" alt="logo" class="img-fluid" width="150" height="80" style="height: 80px;margin-left: 100px;"><br>
      </a>
      <p class="footer-text">
    ...
    success : function (res) {
     ...
     if (res){
                ...
                $('#login_otp_modal').modal('show');
                 ...
                 $('#login_otp').val('');
                 $('#register_mobile').val(user_mobile);
               } 
