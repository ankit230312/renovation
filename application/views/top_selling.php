        ...
        <?php 
               ...
               if(!empty($best_selling_pro)){
                ...
                foreach($best_selling_pro as $d){
                 ...
                 $CI =& get_instance();
                 $product = $this->db->query("select products_variant.*,products.product_name,products.product_image,products.max_quantity from products_variant inner join products on products_variant.product_id=products.productID where products_variant.product_id='$d->productID'")->row();
               ...
               if(!empty($product)){
                 $variants = $this->db->query("select * from products_variant where is_default='1' AND product_id='$d->productID'")->row();
         ...
         <div class=" col-md-3 col-6 col-sm-6 col-xs-6" style="margin-bottom: 20px!important;">
            <div class="product-grid4">
                 <div class="product-image4">
                     ...
                     <span
                        class="product-discount-label"><?=ceil((($product->retail_price-$product->price)/$product->retail_price)*100); ?>% OFF</span>
                  </div>
