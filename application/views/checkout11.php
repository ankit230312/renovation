...
<div class="col-md-4">
  <div class="right border">
    ...
    if(!empty($carts)){
      ...
      <div class="row lower">
        ...
        <div class="col text-right">₹<?php  if ($sub_total > 1000) {
           echo $delivery_charge = 30;
          }else{
           echo $delivery_charge = 50;
          }?></div>
      </div>
  ...
  <div class="modal fade" id="applycoupon" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <form id="order_place" method="post" action="<?=base_url('home/place_order')?>">
      ...
      <input type="hidden" name="cart_total" id="cart_total" value="<?=$sub_total?>">
      ...
      success : function (res) {
        if(res.status){
          ...
          if(type == 'discount'){
            ...
            if (total >1000 ) {
              var delivery_charges = 30;
               delivery_charges = parseInt(delivery_charges);
              var sub_total = parseInt(total) - parseInt(amount) + parseInt(delivery_charges);
            }else{
  ...
  $("#place_order").click(function(){
    ...
    if(payment_method == 'cod'){
     ...
     var options = {
      ...
      key: "rzp_test_a47BCOLPPkaYO2",
      //rzp_live_kNpmPYYnMbMwQE
        //key: "rzp_test_hknTNWccXk6Ax9",
        amount: total * 100,
  ...
  $( document ).ready(function() {
    ...
    if($("#cashback").is(':checked')){
      ...
      if(amount > total){
       // alert(total);
       if (total > 1000) {
       var sub_total = parseInt(amount) - parseInt(total) + 30;
       }else
       {
        var sub_total = parseInt(amount) - parseInt(total) + 50;
       }
       ...
       if (total > 1000) {
        var sub_total = parseInt(total) - parseInt(amount) + 30;
       }else
       {
       var sub_total = parseInt(total) - parseInt(amount) + 50;
       }
   ...
   var total = '<?php echo $sub_total?>';
    amount = parseInt(amount);
      total = parseInt(total);
if (total > 1000 ) {
  var sub_total = parseInt(total)  + 30;
}
else{
  var sub_total = parseInt(total)  + 50;
}
