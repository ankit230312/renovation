		...
		<div class="row about_row">
			...
			<div class="col-lg-4 about_col about_col_middle">
				<div class="about_item">
					...
					<div class="about_item_text">
						<p>At Splitfloor, our mission is to accelerate household renovations by delivering meticulously pre-curated design solutions that inspire and simplify the transformation process. We empower our customers with seamless budget estimation through an integrated platform featuring comprehensive layout data which ensure cost transparency and facilitate in swift & confident decision-making.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 about_col about_col_right">
				<div class="about_item">
					...
					<div class="about_item_text">
						<p>At Splitfloor, we aspire to be the premier destination for homeowners embarking on renovation journeys</p>
					</div>
				</div>
			</div>
