            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required type="text" value="<?php echo $products[0]->product_name ?>" name="product_name" placeholder="Enter Society Title">
                                </div>
                            </div>
                        </div>
                        <!--<div class="row clearfix">-->
                        <!--    <div class="col-sm-12">-->
                        <!--        <div class="form-group">-->
                        <!--            <label>Society Description 1</label>-->
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="<?php echo $products[0]->floor_types ?>" required type="text" name="property_type" placeholder="Enter Property Type">
                                </div>
                            </div>
                        </div>
                        <!--<div class="row clearfix">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="brand_id">
                                        ...
                                        <?php foreach ($brand as $b) {   ?>
                                            <option selected value="<?= $b->brandID ?>"><?= $b->title ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Society Status <span class="text-danger">*</span> :</label>
                        ...
                        <!--    <div class="col-sm-12">-->
                        <!--        <div class="form-group">-->
                        <!--            <label>Society MRP <span class="text-danger">*</span> :</label>-->
                        ...
                        <!--    <div class="col-sm-12">-->
                        <!--        <div class="form-group">-->
                        <!--            <label>Society Selling Price <span class="text-danger">*</span> :</label>-->
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (i in subcategory) {
                        option += '<option selected value="' + subcategory[i]['categoryID'] + '">' + subcategory[i]['title'] + '</option>';
                    }
                    //alert(option);
