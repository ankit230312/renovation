        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="header">
                    ...
                    <h2 class="text-left"><a class="btn btn-sm btn-primary" href="<?=base_url("brand/brand_management/list")?>"><i class="zmdi zmdi-arrow-back"></i> List</a></h2>
                        ...
                        <!-- <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?=base_url("uploads/brand/$category->image")?>" style="height: 80px;max-width: 80%">
