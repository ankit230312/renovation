            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url("Accessory/cate") ?>">Accessory Category Management</a></li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="header">
                    ...
                    <h2 class="text-left"><a class="btn btn-sm btn-primary" href="<?= base_url("Accessory/cate") ?>"><i class="zmdi zmdi-arrow-back"></i> List</a></h2>
