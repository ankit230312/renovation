    ...
    <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url("banners/deal_banners")?>">Deal Banners</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2 class="text-left"><a class="btn btn-primary btn-sm" href="<?=base_url("banners/deal_banners/add")?>"><i class="zmdi zmdi-plus"></i> Add</a></h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover table-sm dataTable js-exportable">
                                ...
                                <?php foreach ($banners as $p){?>
                                    <tr>
                                        <td><?=$p->bannerID?></td>
                                        <td><img src="<?=base_url("uploads/banners/$p->banner")?>" style="height: 150px"></td>
                                        <td><?=wordwrap($p->text,25,"<br>\n")?></td>
                                            ...
                                            <ul class="header-dropdown" style="list-style: none">
                                                <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle btn btn-round btn-sm" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Action </a>
                                                    <ul class="dropdown-menu slideUp">
                                                        <li><a href="<?=base_url("banners/deal_banners/edit/$p->bannerID/")?>">Edit</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </td>
