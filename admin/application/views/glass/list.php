    ...
    <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url("Items") ?>">Enclosure List</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <?php if ($_SESSION['role'] == 'admin') { ?><h2 class="text-left"><a class="btn btn-primary btn-sm" href="<?= base_url("Glass/add") ?>"><i class="zmdi zmdi-plus"></i> Add</a>
                                ...
                                ?>
                                        <tr class="<?php echo $low_stocl ?>">
                                            ...
                                            <?php if ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'subadmin') { ?>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Glass/toggle_status/' . $p->productID) ?>"
                                            ...
                                            <?php } elseif ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'subadmin') { ?>
                                                ...
                                                <td>
                                                    <?php if ($_SESSION['role'] == 'admin') { ?>
                                                        <a href="<?= base_url("Glass/delete_products/$p->productID") ?>"
...
<script>
    ...
    function toggleVisibility(productID, el) {
        let status = el.checked ? 'Y' : 'N';
