                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control js-example-basic-single" name="productID" required>
                                            <?php foreach ($products as $p){?>
                                                <option value="<?=$p->productID?>"><?=$p->product_name.' ('.$p->price.' / '.$p->unit_value.' '.$p->unit.') '?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="number" step="0.01" placeholder="Enter Deal Price" name="deal_price">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="number" placeholder="Enter Max Quantity" name="max_quantity">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="date" placeholder="Enter Start Date" value="<?=date("Y-m-d")?>" name="start_date">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="date" placeholder="Enter End Date" value="<?=date("Y-m-d")?>" name="end_date">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
