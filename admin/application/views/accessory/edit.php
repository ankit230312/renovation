                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required type="text" name="product_name" value="<?php echo $products->accessory_name ?>" placeholder="Enter Society Title">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="cateogry_id" name="cateogry_id">
                                        ...
                                        <option value="<?= $item_category->category_id ?>"><?= $item_category->title ?></option>
