                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-striped table-hover table-sm dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    if (!empty($new_orders)) {
                                        foreach ($new_orders as $a) {

                                            $secret = md5($a->orderID);
                                                            ...
                                                            <div class="modal-body pd-25">
                                                                ...
                                                                <?php if ($a->status == 'PLACED' && ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'order_manager')) { ?>
                                                                    ...
                                                                    <select class="form-control" name="delivery_agent" id="vendor_<?= $a->orderID ?>">
                                                                        ...
                                                                        <?php
                                                                        //    $vendor = $this->db->get_where('admin', array('role' => 'vendor', 'city_id' => $a->cityID))->result();
                                                                        $vendor = $this->db->get_where('admin', array('role' => 'vendor'))->result();
                                                                        if (!empty($vendor)) {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".save").click(function() {
            ...
            console.log(id, status, delivery_agent);
            if (status != '')
