                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="header-dropdown" style="list-style: none">
                                                ...
                                                <li><a role="menuitem" class="btn btn-default" style="padding:2px"  tabindex="-1" data-toggle="modal" data-target="#modaldemo<?=$a->orderID?>">Update Status</a><a role="menuitem" class="btn btn-primary" style="padding:2px"   tabindex="-1" href="<?=base_url("orders/order_detail/").$a->orderID?>">Details</a></li>
                                            ...
                                            <div class="modal-dialog modal-dialog-vertical-center" role="document">
                                                ...
                                                <div class="modal-content bd-0 tx-14">
                                                    ...
                                                    <div class="modal-body pd-25">
                                                        ...
                                                        <?php } elseif($a->status == 'CONFIRM' ||$a->status == 'PACKED' && ($_SESSION['role']=='admin' || $_SESSION['role']=='order_manager')){ ?>
                                                        ...
                                                        <?php } elseif(($_SESSION['role']=='admin' || $_SESSION['role']=='order_manager')  && $a->status == 'OUT_FOR_DELIVERY' || $a->status == 'ALLOCATED' ){ ?>
