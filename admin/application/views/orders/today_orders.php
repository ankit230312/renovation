            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('orders/today_orders')?>"><i class="zmdi zmdi-home"></i></a></li>

                        <li class="breadcrumb-item">today Orders</li>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-striped table-hover table-sm dataTable js-exportable" >
                                ...
                                <?php
                                 ...
                                 foreach ($today_orders as $a){ $secret = md5($a->orderID);
