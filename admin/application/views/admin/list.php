            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <h2 class="text-left"><a class="btn btn-primary btn-sm" href="<?=base_url("home/admin/add")?>"><i class="zmdi zmdi-plus"></i> Add</a></h2>
                                ...
                                <?php foreach ($admin as $a){ $secret = md5($a->id); ?>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><ul>
                                            ...
                                            $categories = explode(',', $a->category_id);
                                            ...
                                            for($i=0 ; $i<sizeof($categories); $i++) {
                                                ...
                                                $c = $this->home_m->get_single_row_where('category',array('categoryID'=>$categories[$i]));
                                            ...
                                            <ul class="header-dropdown" style="list-style: none">
                                                ...
                                                <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle btn btn-round btn-sm" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Action </a>
                                                    ...
                                                    <ul class="dropdown-menu slideUp">
                                                        ...
                                                        <li><a href="<?=base_url("home/admin/edit/$a->id/$secret")?>">Edit</a></li>
