    ...
    <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url("glass/product_society_map") ?>">Glass Enclosure Map</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url("glass/product_society_map") ?>">Glass Enclosure Map Management</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2 class="text-left"><a class="btn btn-primary btn-sm" href="<?= base_url("glass/product_society_map_add") ?>"><i class="zmdi zmdi-plus"></i> Add</a></h2>
                    </div>
                    <div class="body">
