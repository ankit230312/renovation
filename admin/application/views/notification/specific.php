            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12">
                    ...
                    <ul class="breadcrumb padding-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url("notification")?>">Notification</a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <h2 class="text-left">Send Multiple User Notification</h2>
                    ...
                    <div class="body">
                        ...
                        <h2 class="title text-success"><?php echo $this->session->flashdata('msg')?></h2>

                        <?php } ?>

                        <form class="form" action="<?=base_url('notification/specific')?>" method="post" enctype="multipart/form-data">
