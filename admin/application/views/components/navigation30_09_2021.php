    ...
    <div id="leftsidebar" class="sidebar">
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="<?=base_url("home/vendor")?>"><i class="zmdi zmdi-face"></i><span>Vendor</span></a></li>
                <?php }?>
                ...
                $enquiryCount = ''; 
                 ...
                 ?>
                <li> <a href="<?=base_url('enquiry')?>"><i class="zmdi zmdi-label"></i><span>Enquiry <span class="badge"><?= $enquiryCount?></span></span></a></li>
                <li> <a href="<?=base_url('deals')?>"><i class="zmdi zmdi-local-offer"></i><span>Deals</span></a></li>
                <li><a href="<?=base_url("banners")?>" onclick="return false;" class="menu-toggle"><i class="zmdi zmdi-slideshow"></i><span>Banners</span></a>
                    <ul class="ml-menu">
                        ...
                        <li><a href="<?=base_url("banners/deal_banners")?>">Deal Banners</a></li>
                          <li><a href="<?=base_url("banners/web_banners")?>">Web Banners</a></li>
                          <li><a href="<?=base_url("banners/new_banners")?>">New Banners</a></li>
                           <li><a href="<?=base_url("banners/web_other_banners")?>">Other Web  Banners</a></li>
                    </ul>
                </li>
                <?php } ?>
                <?php  if($_SESSION['role']=='admin' || $_SESSION['role']=='subadmin' || $_SESSION['role']=='order_manager'){ ?>
            ...
            <?php } ?>
             <?php  if($_SESSION['role']=='admin' || $_SESSION['role']=='subadmin' || $_SESSION['role']=='order_manager'){ ?>
                <li><a href="<?=base_url("abandon_cart")?>"><i class="zmdi zmdi-shopping-cart"></i><span>Abandon Cart</span></a>
                </li>
            <?php } ?>
                <?php if($_SESSION['role']=='admin' || $_SESSION['role']=='subadmin'){?>    
                ...
                <?php if($_SESSION['role']=='admin'){?>
                 <li><a href="<?=base_url("notification")?>" onclick="return false;" class="menu-toggle"><i class="zmdi zmdi-home"></i><span>Report</span></a>
                    <ul class="ml-menu">
