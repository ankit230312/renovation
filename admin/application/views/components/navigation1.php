    ...
    <div id="leftsidebar" class="sidebar">
        <div class="menu">
            <ul class="list">
                ...
                <li> <a href="<?=base_url()?>"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
            <?php if($_SESSION['role']=='admin'){?>
                ...
                <li> <a href="<?=base_url('enquiry')?>"><i class="zmdi zmdi-label"></i><span>Enquiry</span></a></li>
            ...
            <?php if($_SESSION['role']=='admin' || $_SESSION['role']=='subadmin'){?>    
                ...
                <!-- <li> <a href="<?=base_url('home/stock_report')?>"><i class="zmdi zmdi-home"></i><span>Stock Purchase Report</span></a></li> -->
                 <li><a href="<?=base_url("notification")?>" onclick="return false;" class="menu-toggle"><i class="zmdi zmdi-home"></i><span>Report</span></a>
                    <ul class="ml-menu">
                        <li><a href="<?=base_url("orders/report")?>">Order Inoice</a></li>
