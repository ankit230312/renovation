...
class GOWISE extends CI_Controller
{
    ...
    public function get_brand_home($brandID)
    ...
    public function products_by_brand()
    {
        ...
        if ($query !== FALSE) {
            ...
            foreach ($brands as $brand) {
                ...
                if (!empty($products)) {
                    foreach ($products as $p) {
                        ...
                        $p->brand = $brandInfo->brand; // Use a different variable for brand info
            ...
            $final_response = array('result' => 'success', 'brand' => $response);
...

    {
        ...
        $response[] = array('result' => 'success', 'addressID' => $addressID, 'message' => 'Default Address set');
