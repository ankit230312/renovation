...
class Reports extends MY_Controller
{
    ...
    public function today_order()
    {
        ...
        $this->db->group_by('variantID'); 

        $today_order = $this->db->get_where('order_items',$condition)->result();
        // echo $this->db->last_query();
        // exit();
        $this->data['today_order'] = $today_order;
        $this->data['sub_view'] = 'transaction/today_order';
        $this->data['title'] = 'Today order Reports';
        $this->load->view("_layout", $this->data);
    }
}