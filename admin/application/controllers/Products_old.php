...
class Products extends CI_Controller
{
  ...
  //import data
    ...
    public function add()
    {
        ...
        if ($_POST && $_FILES){
            ...
            if($productId > 0)
            {
                ...
                $insert_variant['quantity'] = $this->input->post('unit_value');
                ...
                $insert_variant['variant_image'] = $actual_image_name;
                  $this->city_wise_variant_price($productId,$insert_array['retail_price'],$insert_variant['price'], $insert_variant['quantity'], $insert_variant['unit'],$insert_variant['stock_count'],$insert_array['cost_price'],$insert_variant['is_default'],$insert_variant['in_stock'],$insert_variant['variant_image'],$insert_array['vegtype']);
            }
    ...
    //city wise variants
    public function city_wise_variant_price($productID,$retail_price,$price,$unit_value,$unit,$stock_count,$cost_price,$is_default,$in_stock,$variantImage,$vegtype)
    {
    ...
    public function add_variants()
    {
        if ($_POST){
                ...
                $insert_array['quantity'] = $this->input->post('unit_value');
