    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <?php if($_SESSION['role']=='admin'){?><h2 class="text-left"><a class="btn btn-primary btn-sm" href="<?=base_url("products/add")?>"><i class="zmdi zmdi-plus"></i> Add</a>
                            <!-- <a class="btn btn-primary btn-sm" href="#products_bulk_modal" data-toggle="modal" data-target="#products_bulk_modal" style="background:#f96332; border: none;"><i class="fas fa-plus" ></i> Import</a></h2> -->
                        <?php } ?>
                    </div>
                    <div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover table-sm dataTable js-exportable">
                                <thead>
                                <tr>
                                    <th> <?php if($_SESSION['role']=='admin'){echo 'ID';}else{echo 'Sr.No';}?></th>
                                    <th>PRODUCT</th>
                                    <th>CATEGORY</th>
                                    <th>SUB CATEGORY</th>
                                ...
                                <tbody>
                                <?php foreach ($products as $key => $p){ $c = $key+1;?>
                                    <tr>
                                        <td><?php if($_SESSION['role']=='admin'){echo $p->productID;}else{echo $c;}?></td>
                                        ...
                                        </span><?php }else{ echo wordwrap($p->product_name,35,"<br>\n") ;}?></td>
                                    ...
                                    <?php }elseif($_SESSION['role']=='admin'){?>
                                        <td><?=$p->unit?></td>
                                        <td><a href="javascript:void(0)" onclick="active_inactive_product('<?=$p->productID?>')"><span><?php if ($p->in_stock == 'Y'){echo "Active";}else{echo 'InActive';}?></span></a></td>
                                            <td>
