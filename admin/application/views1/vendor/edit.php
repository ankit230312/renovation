                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control city_id" name="city_id" id="cities" required>
                                ...
                                $pin_code = $this->db->query("SELECT * FROM locality WHERE status = 'Y' AND locality = '$admin_info->city_id'")->result();
