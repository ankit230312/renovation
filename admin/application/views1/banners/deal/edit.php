<section class="content">
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2 class="text-left"><a class="btn-sm btn btn-primary" href="<?=base_url("banners/deal_banners/list")?>"><i class="zmdi zmdi-arrow-back"></i> List</a></h2>
                </div>
                <div class="body">
                    <?php if (isset($error)){?>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" required name="text" placeholder="Enter Some text about this Deal"><?=$banners->text?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
