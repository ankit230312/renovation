...

{
...

    {
        ...
        $select = "site_name,logo,favicon,min_order_amount,max_order_amount,free_delivery_amount,delivery_charge,cashback_discount,min_amount_cashback,refer_earn,mobile,mobile2";
