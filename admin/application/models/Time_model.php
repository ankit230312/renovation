...
class Time_model extends CI_Model{
        ...
        function get_start_closing_date($date){
           $q = $this->db->query("Select * from closing_hours where start_date >= '".date("Y-m-d",strtotime($date))."' AND date >= '".date("Y-m-d",strtotime($date))."'");
            return $q->result(); 
        }
