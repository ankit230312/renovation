																...
																<div class="team_item">
																	<div class="team_body">
																		...
																		<div class="area_sq_ft">
																			...
																			<div>
																				<p class="value">
																					<?= htmlspecialchars(intval($row['area_sqft'])) ?>
																					SQFT
																				</p>
																			</div>
																		</div>
																				...
																				<div
																					...
																					<div class="row my-3">
																						...
																						if ($productItem['category_id'] == 15) { 
																							...
																							<div class="col-md-6">
																								<a
																									href="product_detail.php?proId=<?= $productId ?>">
																									<h5 class="card-title">
																										<?= htmlspecialchars($productItem['product_name']) ?>
																									</h5>
																								</a>
																								...
																								<?php if ($hasOffer): ?>
																									<p class="mb-1">
																										<span
																											class="fw-bold badge bg-success"><?= htmlspecialchars($offerText) ?></span><br>
																										<small class="text-muted">Valid till
																											<?= date('d M Y', strtotime($productItem['end_date'])) ?></small>
																									</p>
																									<p class="text-muted mb-0">
																										<del>₹<?= number_format($productItem['price'], 2) ?></del>
																										<span
																											class="text-danger fw-bold ms-2">₹<?= number_format($finalPrice, 2) ?></span>
																									</p>
																								<?php else: ?>
