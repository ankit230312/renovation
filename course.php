		...
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<div class="course_container">
					...
					<div class="course_title"><?php

												echo $product['product_name'] ?></div>
					...
					<div class="course_tabs_container">
						...
						<div class="tab_panels">
							...
							<div class="tab_panel active">
								<div class="tab_panel_title"><?php echo $product['product_name'] ?></div>
										...
										<div class="team">
											...
											<div class="container">
												...
												<div class="row team_row">
													...
													<?php
													$room_floor_type = "SELECT * FROM floor_type WHERE property_id = $proID";
				...
				<div class="sidebar">
					...
					<div class="sidebar_section">
						...
						<div class="sidebar_feature">
							<div class="course_price">RS <?php echo $product['price'] ?></div>
